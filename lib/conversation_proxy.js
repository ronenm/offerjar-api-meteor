...
//##################################################################################
    ConversationProxy.prototype.update = function(add_params, callback) {
      ...
      return this.apiCall('/conversation_proxies/:uid', 'put', params, add_params,callback);
    }
...
//##################################################################################
    ConversationProxy.prototype.get = function(add_params, callback) {
      ...
      return this.apiCall('/conversation_proxies/:uid', 'get', params, add_params,callback);
    }
...
//
//##################################################################################
    ConversationProxy.prototype.createAffinity = function(add_params, callback) {
      var params = {
         uid: this.uid
      }
      return this.apiCall('/conversation_proxies/:uid/affinities', 'post', params, add_params,callback);
    }
...
//
//##################################################################################
    ConversationProxy.prototype.deleteAffinity = function(user_affinity_token, add_params, callback) {
      var params = {
         uid: this.uid,      user_affinity_token: user_affinity_token
      }
      return this.apiCall('/conversation_proxies/:uid/affinities/:user_affinity_token', 'delete', params, add_params,callback);
    }
...
//
//##################################################################################
    ConversationProxy.prototype.exposeAffinity = function(user_affinity_token, add_params, callback) {
      var params = {
         uid: this.uid,      user_affinity_token: user_affinity_token
      }
      return this.apiCall('/conversation_proxies/:uid/affinities/:user_affinity_token/expose', 'post', params, add_params,callback);
    }
...
//
//##################################################################################
    ConversationProxy.prototype.getAffinitySession = function(user_affinity_token, add_params, callback) {
      var params = {
         uid: this.uid,      user_affinity_token: user_affinity_token
      }
      return this.apiCall('/conversation_proxies/:uid/affinities/:user_affinity_token/session', 'get', params, add_params,callback);
    }
...
//
//##################################################################################
    ConversationProxy.prototype.initiateNegotiation = function(add_params, callback) {
      var params = {
         uid: this.uid
      }
      return this.apiCall('/conversation_proxies/:uid/negotiations/initiate', 'post', params, add_params,callback);
    }
...
//
//##################################################################################
    ConversationProxy.prototype.getNegotiations = function(add_params, callback) {
      var params = {
         uid: this.uid
      }
      return this.apiCall('/conversation_proxies/:uid/negotiations', 'get', params, add_params,callback);
    }
...
//
//##################################################################################
    ConversationProxy.prototype.getNegotiation = function(nuid, add_params, callback) {
      var params = {
         uid: this.uid,      nuid: nuid
      }
      return this.apiCall('/conversation_proxies/:uid/negotiations/:nuid', 'get', params, add_params,callback);
    }
...
//
//##################################################################################
    ConversationProxy.prototype.getNegotiationPoll = function(nuid, add_params, callback) {
      var params = {
         uid: this.uid,      nuid: nuid
      }
      return this.apiCall('/conversation_proxies/:uid/negotiations/:nuid/poll', 'get', params, add_params,callback);
    }
...
//
//##################################################################################
    ConversationProxy.prototype.doNegotiation = function(nuid, transition, add_params, callback) {
      var params = {
         uid: this.uid,      nuid: nuid,      transition: transition
      }
      return this.apiCall('/conversation_proxies/:uid/negotiations/:nuid/:transition', 'put', params, add_params,callback);
    }
...
//##################################################################################
    ConversationProxy.prototype.create = function(add_params, callback) {
      ...
      return this.apiCall('/conversation_proxies', 'post', params, add_params,callback);
    }
