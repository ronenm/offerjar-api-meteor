...
//##################################################################################
    Store.prototype.token = function(add_params, callback) {
      ...
      return this.apiCall('/stores/:uid/token', 'post', params, add_params,callback);
    }
...
//##################################################################################
    Store.prototype.update = function(add_params, callback) {
      ...
      return this.apiCall('/stores/:uid', 'put', params, add_params,callback);
    }
...
//##################################################################################
    Store.prototype.get = function(add_params, callback) {
      ...
      return this.apiCall('/stores/:uid', 'get', params, add_params,callback);
    }
...
//
//##################################################################################
    Store.prototype.getTaxonomies = function(add_params, callback) {
      var params = {
         uid: this.uid
      }
      return this.apiCall('/stores/:uid/taxonomies', 'get', params, add_params,callback);
    }
...
//
//##################################################################################
    Store.prototype.getTaxonomy = function(rid, add_params, callback) {
      var params = {
         uid: this.uid,      rid: rid
      }
      return this.apiCall('/stores/:uid/taxonomies/:rid', 'get', params, add_params,callback);
    }
...
//
//##################################################################################
    Store.prototype.createTaxonomy = function(rid, add_params, callback) {
      var params = {
         uid: this.uid,      rid: rid
      }
      return this.apiCall('/stores/:uid/taxonomies/:rid', 'post', params, add_params,callback);
    }
...
//
//##################################################################################
    Store.prototype.getProducts = function(add_params, callback) {
      var params = {
         uid: this.uid
      }
      return this.apiCall('/stores/:uid/products', 'get', params, add_params,callback);
    }
...
//
//##################################################################################
    Store.prototype.createProduct = function(add_params, callback) {
      var params = {
         uid: this.uid
      }
      return this.apiCall('/stores/:uid/products', 'post', params, add_params,callback);
    }
...
//
//##################################################################################
    Store.prototype.getProduct = function(rid, add_params, callback) {
      var params = {
         uid: this.uid,      rid: rid
      }
      return this.apiCall('/stores/:uid/products/:rid', 'get', params, add_params,callback);
    }
...
//
//##################################################################################
    Store.prototype.updateProduct = function(rid, add_params, callback) {
      var params = {
         uid: this.uid,      rid: rid
      }
      return this.apiCall('/stores/:uid/products/:rid', 'put', params, add_params,callback);
    }
...
//
//##################################################################################
    Store.prototype.getProductImages = function(rid, add_params, callback) {
      var params = {
         uid: this.uid,      rid: rid
      }
      return this.apiCall('/stores/:uid/products/:rid/images', 'get', params, add_params,callback);
    }
...
//
//##################################################################################
    Store.prototype.uploadUrlProductImage = function(rid, add_params, callback) {
      var params = {
         uid: this.uid,      rid: rid
      }
      return this.apiCall('/stores/:uid/products/:rid/images/upload_url', 'post', params, add_params,callback);
    }
...
//
//##################################################################################
    Store.prototype.getProductImage = function(rid, id, style, add_params, callback) {
      var params = {
         uid: this.uid,      rid: rid,      id: id,      style: style
      }
      return this.apiCall('/stores/:uid/products/:rid/images/:id/:style', 'get', params, add_params,callback);
    }
...
//
//##################################################################################
    Store.prototype.deleteProductImage = function(rid, id, add_params, callback) {
      var params = {
         uid: this.uid,      rid: rid,      id: id
      }
      return this.apiCall('/stores/:uid/products/:rid/images/:id', 'delete', params, add_params,callback);
    }
...
//
//##################################################################################
    Store.prototype.reorderProductImage = function(rid, add_params, callback) {
      var params = {
         uid: this.uid,      rid: rid
      }
      return this.apiCall('/stores/:uid/products/:rid/images/reorder', 'post', params, add_params,callback);
    }
...
//
//##################################################################################
    Store.prototype.getButtonProduct = function(buid, add_params, callback) {
      var params = {
         uid: this.uid,      buid: buid
      }
      return this.apiCall('/stores/:uid/buttons/:buid/product', 'get', params, add_params,callback);
    }
...
//
//##################################################################################
    Store.prototype.getButtonCans = function(buid, add_params, callback) {
      var params = {
         uid: this.uid,      buid: buid
      }
      return this.apiCall('/stores/:uid/buttons/:buid/cans', 'get', params, add_params,callback);
    }
...
//
//##################################################################################
    Store.prototype.getButtonCan = function(buid, nuid, add_params, callback) {
      var params = {
         uid: this.uid,      buid: buid,      nuid: nuid
      }
      return this.apiCall('/stores/:uid/buttons/:buid/cans/:nuid', 'get', params, add_params,callback);
    }
...
//
//##################################################################################
    Store.prototype.closeButtonCan = function(buid, nuid, add_params, callback) {
      var params = {
         uid: this.uid,      buid: buid,      nuid: nuid
      }
      return this.apiCall('/stores/:uid/buttons/:buid/cans/:nuid/close', 'post', params, add_params,callback);
    }
...
//##################################################################################
    Store.prototype.create = function(add_params, callback) {
      ...
      return this.apiCall('/stores', 'post', params, add_params,callback);
    }
